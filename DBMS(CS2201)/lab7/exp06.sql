...
Select department_id,count(*) from departments natural join employees group by department_id;
...
-- Write the SQL Statement for the above Question
Select job_id,avg((min_salary+max_salary)/2) from jobs group by job_id;

-- Paste the output of above code and comment your output
/*
# job_id, avg((min_salary+max_salary)/2)
'AC_ACCOUNT', '6600.00000000'
'AC_MGR', '12100.00000000'
'AD_ASST', '4500.00000000'
'AD_PRES', '30000.00000000'
'AD_VP', '22500.00000000'
'FI_ACCOUNT', '6600.00000000'
'FI_MGR', '12100.00000000'
'HR_REP', '6500.00000000'
'IT_PROG', '7000.00000000'
'MK_MAN', '12000.00000000'
'MK_REP', '6500.00000000'
'PR_REP', '7500.00000000'
'PU_CLERK', '4000.00000000'
'PU_MAN', '11500.00000000'
'SA_MAN', '15000.00000000'
'SA_REP', '9000.00000000'
'SH_CLERK', '4000.00000000'
'ST_CLERK', '3500.00000000'
'ST_MAN', '7000.00000000'
*/
...
-- Write the SQL Statement for the above Question
select department_id,count(*) from employees group by department_id having count(employee_id)>10;
...
-- Write the SQL Statement for the above Question
select max(salary),min(salary),avg(salary) from employees group by department_id having max(salary)>10000;

-- Paste the output of above code and comment your output
/*
# max(salary), min(salary), avg(salary)
'13000.00', '6000.00', '9500.000000'
'11000.00', '2500.00', '4150.000000'
'14000.00', '6100.00', '8955.882353'
'24000.00', '17000.00', '19333.333333'
'12000.00', '6900.00', '8600.000000'
'12000.00', '8300.00', '10150.000000'
*/
...
-- Write the SQL Statement for the above Question
select job_id,job_title,avg((min_salary +max_salary)/2) from jobs group by job_id having avg((min_salary +max_salary)/2)>8000;

-- Paste the output of above code and comment your output
/*
# job_id, job_title, avg((min_salary +max_salary)/2)
'AC_MGR', 'Accounting Manager', '12100.00000000'
'AD_PRES', 'President', '30000.00000000'
'AD_VP', 'Administration Vice President', '22500.00000000'
'FI_MGR', 'Finance Manager', '12100.00000000'
'MK_MAN', 'Marketing Manager', '12000.00000000'
'PU_MAN', 'Purchasing Manager', '11500.00000000'
'SA_MAN', 'Sales Manager', '15000.00000000'
'SA_REP', 'Sales Representative', '9000.00000000'
*/
...
-- Write the SQL Statement for the above Question;
select department_id,avg(commission_pct) from employees group by department_id having avg(commission_pct) is not NULL;
-- Paste the output of above code and comment your output
/*
# department_id, avg(commission_pct)
NULL, '0.150000'
'80', '0.225000'
*/
...
-- Write the SQL Statement for the above Question
select manager_id, count(*) from employees group by manager_id order by count(*);
...
-- Write the SQL Statement for the above Question
Select department_id,job_id,sum(salary) from employees group by department_id, job_id order by department_id desc;
Select department_id,job_id,sum(salary) from employees group by department_id, job_id order by sum(salary)desc;
